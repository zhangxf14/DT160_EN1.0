                        ...
                        public void run() {
                            try {
                                ...
                                if (hexString != null && hexString.contains("FAFF")) {
                                    ...
                                    ToastUtil.sToastUtil.shortDuration(UIUtils.getString(R.string.hint_text11));
                                }
...
//                            String hexCount = TransUtil.byteToHex(nfcV.transceive(instructV(32,id)));
                            byte[] transceive2 = nfcV.transceive(instructV(9, id));
                            String result = getHexString(transceive2, transceive2.length);
                            ...
                            if (s.length() > 12 && s.substring(s.length() - 13, s.length() - 12).equals("1")){
                                hexCount = TransUtil.byteToHex(nfcV.transceive(instructV(32,id)));
                                tpCount = Integer.parseInt(hexCount.substring(4)+hexCount.substring(2,4),16)+1;
                                flag = "0";
                            }else {
                        ...
                        String s = NFCUtils.hexStrToBinaryStr(
                                result.substring(result.length() - 2, result.length())
                                        + result.substring(result.length() - 4, result.length() - 2));
                        if (s.length() > 12 && s.substring(s.length() - 13, s.length() - 12).equals("1"))
                            ToastUtil.sToastUtil.shortDuration(UIUtils.getString(R.string.hint_text5));
                        else {
                                ...
                                if(intDelay==delayValue) {
                                    ...
                                    if (IntIntervalTime == intValue) {
                                        ...
                                        if (string1.contains("0000"))
                                            ToastUtil.sToastUtil.shortDuration(UIUtils.getString(R.string.hint_text1));
                                        else
                                            ToastUtil.sToastUtil.shortDuration(UIUtils.getString(R.string.hint_text2));
                                    }else {
                                        ToastUtil.sToastUtil.shortDuration(UIUtils.getString(R.string.hint_text12));
                                    }
                                }else {
                                    ToastUtil.sToastUtil.shortDuration(UIUtils.getString(R.string.hint_text12));
                                }
            ...
            if (type == 2) {
                ...
                message.obj = sb;
                UIUtils.getHandler().sendMessage(message);
                ToastUtil.sToastUtil.shortDuration(UIUtils.getString(R.string.hint_text13));
            }
        } finally {
            try {
                nfcV.close();
                        ...
                        public void run() {
                            try {
                                ...
                                if (hexString != null && hexString.contains("FAFF")) {
                                    ...
                                    ToastUtil.sToastUtil.shortDuration("Error");
                                }
...
//                                        byte[] transceive4 = nfcA.transceive(instructA(42));
//                                        byte[] transceive5 = nfcA.transceive(instructA(43));
//                                        LogUtil.d(TransUtil.byteToHex(transceive4));
//                                        LogUtil.d(TransUtil.byteToHex(transceive5));
    ...
    public static void startV(Tag tag, int type) {
        ...
        try {
            nfcV.connect();
            if (type == 28) {
                byte[] bytes0 = nfcV.transceive(instructV(1, id));
                byte[] bytes = nfcV.transceive(instructV(2, id));
                String hexString1 = getHexString(bytes, bytes.length);
                if (hexString1.contains("5555")) {
                    ...
                    LogUtil.d(getHexString(bytes0, bytes0.length));
                    ...
                    ToastUtil.sToastUtil.longDuration(UIUtils.getString(R.string.hint_text8));
                }
    ...
    public static void startA(Tag tag, int type) {
        ...
        try {
            nfcA.connect();
            if (type == 28) {
                byte[] bytes0 = nfcA.transceive(instructA(1));
                byte[] bytes = nfcA.transceive(instructA(2));
                String hexString1 = getHexString(bytes, bytes.length);
                if (hexString1.contains("5555")) {
...
//        if(tempData.substring(0,1).equals("1")){
//            resultTem = (float) ((parseInt - 0x400)/4.00);
//        }else {
//            resultTem = (float) (parseInt /4.00);
//        }
//        return  resultTem;
